...
![Заполненный отчет](image/17.png){ #fig:017 width=70% }

Загрузили файлы на Github. (рис. [-@fig:018])

![Загрузка файлы на Github](image/18.png){ #fig:018 width=70% }
...
![Лабораторная работа № 3 в формате Markdown](image/19.png){ #fig:019 width=70% }

![Отчёты в 3х форматах: pdf, docx и md](image/20.png){ #fig:020 width=70% }
